...
//   commentaire: string;
//   fichiers: string; // JSON stringified array
//   user?: {
//     email: string;
//     role: string;
//   };
...
//   return (
//     <div className="p-6">
//       <h1 className="text-2xl font-bold mb-6">Liste des notes de frais</h1>
...
//             <p><strong>Titre :</strong> {selectedNote.titre}</p>
//             <p><strong>Statut :</strong> {selectedNote.statut}</p>
//             <p><strong>Date :</strong> {new Date(selectedNote.dateSoumission).toLocaleDateString("fr-FR")}</p>
//             <p><strong>Commentaire :</strong> {selectedNote.commentaire}</p>

//             <div className="mt-4">
//               <p className="font-medium">Pièces justificatives :</p>
//               <ul className="list-disc list-inside">
//                 {JSON.parse(selectedNote.fichiers).map((file: string, index: number) => (
//                   <li key={index}>
//                     <a
